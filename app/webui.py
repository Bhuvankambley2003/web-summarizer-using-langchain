...
with gr.Blocks() as demo:
    ...
    gr.Markdown(
        ...
        ```
        Model: llama3-8b
        Author: Bhuvan Kambley
        Contact: pbhuvankambley2003@gmail.com
        Repo: github.com/Bhuvankambley2003/web-summarizer-using-langchain
        ```"""
    )
...
demo.launch(server_name="127.0.0.4")
